...
- Change the file format of `vins_result_loop.csv` like **[TUM RGB-D dataset](https://vision.in.tum.de/data/datasets/rgbd-dataset/file_formats)**.  
...
- [[SLAM] Analysis of VINS-MONO - [Chinese]](https://blog.actorsfit.com/a?ID=01700-91f3cab4-a3d3-469c-98ef-e6a6b736a63c)  
- [VINS-Mono source analysis 1 - featuretracker (visual frontend)](https://intrepidgeeks.com/tutorial/vinsmono-source-analysis-1featuretracker-visual-front-end)  
- [VINS-Mono source code analysis 2 — vins_estimator1 (pre-integration)](https://blog.fearcat.in/a?ID=01650-c98015d6-1a0e-4cd2-b63f-8a3b8447ab25)  
- [VINS-Mono source analysis 4-vinsestimator3 (non-linear optimization)](https://intrepidgeeks.com/tutorial/vinsmono-source-analysis-4vinsestimator-3-nonlinear-optimization)  
- [VINS-Mono source analysis 6 - posegraph1 (ring inspection and relocation)](https://intrepidgeeks.com/tutorial/vinsmono-source-resolution-6posegraph1-check-and-reposition-ring)  
- [ManiiXu/VINS-Mono-Learning](https://github.com/ManiiXu/VINS-Mono-Learning)  
- [vins learning code logic](https://intrepidgeeks.com/tutorial/vins-learning-code-logic)  

## Original README.md

<details>
<summary> VINS-MONO </summary>
<div markdown="1">
